...
export class Shelter1684853343588 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pets" ("id" SERIAL NOT NULL, "name" text NOT NULL, "age" smallint NOT NULL, "photo" text NOT NULL, "address" text NOT NULL, "description" text NOT NULL, "breed" text NOT NULL, "isActive" boolean NOT NULL, CONSTRAINT "PK_d01e9e7b4ada753c826720bee8b" PRIMARY KEY ("id"))`);
